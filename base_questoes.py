questoes = [{'titulo': 'Qual o resultado da operação 57 + 32?',
         ...
         {'titulo': 'Quantos lados possui um hexágono?',
          'nivel': 'facil',
         ...
         {'titulo': 'Qual destes animais é um mamífero?',
          'nivel': 'facil',
          'opcoes': {'A': 'Tubarão', 'B': 'Pinguim', 'C': 'Golfinho', 'D': 'Tartaruga'},
          'correta': 'C'},

         {'titulo': 'Qual é o resultado da operação 12 / 3 + 4?',
          'nivel': 'facil',
          'opcoes': {'A': '8', 'B': '7', 'C': '5', 'D': '16'},
          'correta': 'A'},

         {'titulo': 'Qual estrutura de dados do Python utiliza pares de chave e valor?',
          'nivel': 'medio',
          'opcoes': {'A': 'Lista', 'B': 'Tupla', 'C': 'Dicionário', 'D': 'String'},
          'correta': 'C'},

         {'titulo': 'Qual destes elementos químicos possui o símbolo Fe?',
          'nivel': 'medio',
          'opcoes': {'A': 'Flúor', 'B': 'Ferro', 'C': 'Fósforo', 'D': 'Frâncio'},
          'correta': 'B'},

         {'titulo': 'Qual é o resultado da expressão 2 ** 3 + 5 em Python?',
          'nivel': 'medio',
          'opcoes': {'A': '11', 'B': '13', 'C': '16', 'D': '25'},
          'correta': 'B'},

         {'titulo': 'Qual cientista formulou as três leis do movimento clássico?',
          'nivel': 'dificil',
          'opcoes': {'A': 'Isaac Newton', 'B': 'Charles Darwin', 'C': 'Louis Pasteur', 'D': 'Niels Bohr'},
          'correta': 'A'},
         ...
         {'titulo': 'Qual é o valor decimal do número binário 1010?',
          'nivel': 'dificil',
          'opcoes': {'A': '8', 'B': '10', 'C': '12', 'D': '14'},
          'correta': 'B'}
        ]